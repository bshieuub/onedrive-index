...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'bshieu@Ungbuoubmt.com',
  ...
  title: "BS Hiếu BMT's Drive",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/UB_BSHIEU',
  ...
  email: 'mailto:bshieu@ungbuoubmt.com',
